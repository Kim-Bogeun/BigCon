    ...
    if not franchise_name.strip():
        ...
        if record is None:
            ...
            cluster_dict = {
                0: { 
                    0: "기초, 전통 식자재형",
                    1: "고령층 및 여성 중심 방문, 생필·식자재 중심 업종",
                    2: "건어물, 건강원, 농산물, 미곡상, 수산물, 식품 제조, 축산물"
                },
                1: {
                    0: "여가, 미식 소비형",
                    1: "20–30대 주요 방문 및 성별 균형, 카페·베이커리·와인바 등 감성소비 업종",
                    2: "카페, 커피전문점, 베이커리, 와인바, 일식당, 양식, 마카롱 등"
                },
                2: {
                    0: "실속 외식형",
                    1: "전연령대 고루 방문, 남성 비중 다소 높음, 치킨, 맥주, 한식, 육류 등 회식, 외식 중심",
                    2: "치킨, 호프/맥주, 한식-육류, 피자, 중식당, 분식, 포장마차 등"
                },
                3: {
                    0: "건강 프리미엄형",
                    1: "중장년 및 여성 중심 방문, 건강식·반찬·죽 등 웰빙 중심 업종",
                    2: "건강식품, 반찬, 인삼제품, 청과물, 떡/한과 제조, 유제품, 한식-죽"
                }
            }
            cluster_text = f"""
{franchise_name} 가맹점은 {cluster_dict[cluster][0]} 업종입니다. \n\n

- 이 유형의 업종은 다음과 같은 특징을 가집니다: 

{cluster_dict[cluster][1]} \n\n


- 이 유형의 업종에 포함되는 경쟁사들은 다음과 같습니다:

{cluster_dict[cluster][2]}
"""
